...
export function ModuleSummaryView ({data, index} : ModuleSummaryViewProps) {
    ...
    return <div className="row">
        ...
        <div className="row">
                <div className="col-sm-5"><PassedIcon className="icon" /><small>Passed</small></div>
        ...
        <div className="row">
                <div className="col-sm-5"><FailedIcon className="icon" /><small>Failed</small></div>
        ...
        <div className="row">
                <div className="col-sm-5"><SkippedIcon className="icon" /><small>Skipped</small></div>
